...
.DESCRIPTION
    This script launches each microservice in a new window.
    It automatically detects the project root regardless of where it is called from.
#>
...
Write-Host "   [3/8] Starting Gateway Service..." -ForegroundColor Cyan
